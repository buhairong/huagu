  ...
  <view class="cardPage commonPage">
    ...
    <view class="m-avatar">
      <u-image
        ...
        height="160"
        shape="circle"
        :src="userInfo.logoImage || '/static/logo.png'"
      />
        ...
        <u-col span="8">
          <view v-if="userInfo.companyName" class="u-flex">
            <view class="u-flex m_company_line">
              <view>
                <u-icon
                  name="/static/identify/icon_corp.png"
                  color="#999999"
                  size="28"
                  @click="handleShare"
                />
          ...
          <view v-if="userInfo.job" class="u-flex">
            <view class="u-flex m_company_line">
              <view class="u-padding-top-10">
                <u-icon
                  name="/static/identify/icon_card.png"
                  color="#999999"
                  size="28"
                  @click="handleShare"
                />
          ...
          <view class="u-flex">
            <view class="u-flex m_company_line">
              <view>
                <u-icon
                  name="/static/identify/icon_phone.png"
                  color="#999999"
                  size="28"
                  @click="handleShare"
                />
  ...
  export default {
    data() {
      return {
        ...
        list: [
          { image: '/static/identify/me_1.png', title: '111' },
          { image: '/static/identify/me_1.png', title: '222' },
        ]
      }
    },
    onShow() {
