    ...
    <view class="u-flex" @click="handleTodoList">
      <view class="">
        <u-image
          width="112"
          height="112"
          src="https://image.51cheyaoshi.com/xcx/partner/static/message/todo.png"
          shape="circle"
          mode="aspectFit"
        >
    ...
    <view class="u-flex u-margin-top-48" @click="handleNotice">
      <view class="">
        <u-image
          width="112"
          height="112"
          src="https://image.51cheyaoshi.com/xcx/partner/static/message/sysnotice.png"
          shape="circle"
          mode="aspectFit"
        >
          <u-loading slot="loading" />
    ...
    <view class="u-flex u-margin-top-48" @click="handleMsg">
      <view class="">
        <u-image
          width="112"
          height="112"
          src="https://image.51cheyaoshi.com/xcx/partner/static/message/sysmsg.png"
          shape="circle"
          mode="aspectFit"
        >
          <u-loading slot="loading" />
