<template>
	<view class="page" v-if="orderDetail">
		...
		<view style="width:100%;padding:0 32rpx;margin-top:32px;">
			...
			<!-- <view class="btn-group" v-if="orderDetail.bindedCar == 1 && (orderDetail.status === 3 || orderDetail.status === 13)">
				<view class="btn" @click="getCarsMethod">换绑车辆</view>
				<view class="btn primary-btn" @click="getCarInShopMethod">到店验车</view>
			</view> -->
