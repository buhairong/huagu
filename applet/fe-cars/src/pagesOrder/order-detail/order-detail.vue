<template>
	<view class="order-detail" v-if="orderInfo.userCarSubscribeEntity">
				...
				<view class="card-container">
					...
					<view class="item">
						...
						<view class="item-content" @click="togglePaymentBlock(1)">
							￥{{userCarSubscribeEntity.mouthPayment | $numFormat}}/月
							<u-icon
					...
					<view class="card-container total-payment" v-if="showPaymentBlock1">
						<view class="item">
							...
							<view class="item-content">￥{{userCarSubscribeEntity.mouthPayment*userCarSubscribeEntity.monthTotal | $numFormat}}</view>
						</view>
		...
		<u-gap
				v-if="paymentStatus == 3 || paymentStatus == 8 || paymentStatus == 12 || paymentStatus == 14"
		    height="190"
		/>
