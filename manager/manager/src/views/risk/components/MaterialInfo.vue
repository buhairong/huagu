<template>
    <div class="wrap">
        ...
        >
            ...
            >
                <template slot-scope="scope">
                    <div class="transfer" v-if="(scope.row.imageUrl && scope.row.imageUrl.length)">
                        <el-image
            ...
            >
                <template slot-scope="scope">
                    ...
                    <div class="material-btn-group" v-else>
                        <div class="btn" @click="passMaterial(scope.row)">通过</div>
                        <div class="btn refuse-btn" @click="refuseMaterial(scope.row)">拒绝</div>
                    </div>
                </template>
            </el-table-column>
        </el-table>
