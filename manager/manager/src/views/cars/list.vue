<template>
    <div>
        <el-breadcrumb separator="/">
            <el-breadcrumb-item class="subscription-plan">车辆管理</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="content">
            ...
            >
                ...
                >
                    <template slot-scope="scope">
                        <div v-if="scope.row.otherConfig.length > 3">
                            <el-tooltip class="item" effect="dark" :content="scope.row.otherConfig.join('\n')">
                                <div>
                                    <div class="other-config" v-for="(item, index) in scope.row.otherConfig.slice(0, 3)" :key="index">
                                        {{ item }}
                                    </div>
                                </div>
                            </el-tooltip>
                        ...
                        <div v-else>
                            <div class="other-config" v-for="(item, index) in scope.row.otherConfig" :key="index">
                                {{ item }}
                            </div>
                        </div>
                    </template>
                ...
                >
                    <template slot-scope="scope">
                        <div class="table-btn" @click="goCarDetailPage(scope.row)">查看详情</div>
                        <div class="table-btn" @click="goSaveCarPage('edit', scope.row)">编辑车辆</div>
...
export default {
    ...
    methods: {
        ...
        carListByPage() {
            carListByPage(this.search).then((res) => {
                if (res.code == 0) {
