<template>
  <div>
      <el-breadcrumb separator="/">
          ...
          <el-breadcrumb-item class="subscription-plan">产品排序</el-breadcrumb-item>
      </el-breadcrumb>
...
<script>
import { selectList, addBusinessSort, updateBusinessSort, deleteBusinessSort, sortSubscribe } from '@/api/subscribe/subscribe'
  ...
  methods: {
    ...
    del(id) {
      this.$confirm(`确定要删除这个产品吗？`, '提示', {
          ...
          deleteBusinessSort(data).then(res => {
            if (res.code === 0) {
